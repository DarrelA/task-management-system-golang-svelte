    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 252, 10, 7113);
    			attr_dev(path1, "d", "M5 8l4 4 4-4z");
    			attr_dev(path1, "class", "svelte-1i3qjsm");
    			add_location(path1, file$1, 257, 116, 7516);
    			...
    			add_location(svg1, file$1, 257, 10, 7410);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 265, 6, 7719);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 267, 10, 7880);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file, 55, 1, 1448);
    			option1.__value = "Project Manager";
    			option1.value = option1.__value;
    			add_location(option1, file, 56, 1, 1502);
    			option2.__value = "Team Member";
    			option2.value = option2.__value;
    			add_location(option2, file, 57, 1, 1561);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 49, 0, 1052);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Username");
    			add_location(input0, file, 50, 0, 1080);
    			add_location(br0, file, 50, 66, 1146);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file, 51, 0, 1152);
    			add_location(br1, file, 51, 70, 1222);
    			attr_dev(input2, "type", "email");
    			attr_dev(input2, "placeholder", "Email");
    			add_location(input2, file, 52, 0, 1228);
    			add_location(br2, file, 52, 61, 1289);
    			add_location(br3, file, 58, 15, 1626);
    			option0.__value = "Active";
    			option0.value = option0.__value;
    			add_location(option0, file, 60, 1, 1684);
    			option1.__value = "Inactive";
    			option1.value = option1.__value;
    			add_location(option1, file, 61, 1, 1726);
    			attr_dev(select, "placeholder", "Status");
    			if (/*status*/ ctx[4] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[12].call(select));
    			add_location(select, file, 59, 0, 1632);
    			add_location(br4, file, 62, 10, 1780);
    			add_location(button, file, 64, 0, 1788);
    			set_style(div, "text-align", "center");
    			add_location(div, file, 48, 0, 1019);
    			add_location(p0, file, 67, 0, 1853);
    			add_location(p1, file, 68, 0, 1879);
    			add_location(li0, file, 71, 1, 1909);
    			add_location(li1, file, 72, 1, 1941);
    			add_location(li2, file, 73, 1, 1973);
    			add_location(li3, file, 74, 1, 1999);
    			add_location(li4, file, 75, 1, 2034);
    			add_location(ul, file, 70, 0, 1902);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
